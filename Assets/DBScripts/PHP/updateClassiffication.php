<?php
    ...
    $InsertQuery = "UPDATE `classiffication` SET `Time` = '".$UserTime."', `Damage`='".$UserDamage."', `Fuel`='".$UserFuel."' WHERE `Nickname` = '".$UserNickname."' AND  `Map` = '".$UserMap."' AND `Leg` = '".$UserLeg."' AND `Stage` = '".$UserStage."'";
